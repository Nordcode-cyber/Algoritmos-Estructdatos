...
Es una forma de resolver el problema de la mochila que utiliza una matriz de tamaño ${n}$ x ${m}$, donde ${n}$ es el número de objetos,
 y ${m}$ es el peso máximo permitido en la mochila. Cada elemento de la matriz se calcula de la siguiente forma:
