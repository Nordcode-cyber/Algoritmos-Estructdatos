public class Darray {
   /*clase Darray Mergesort
	...
	public Darray(int max){ //  metodo constructor
	vector = new long[max];
	nElementos = 0;
	}
	/*
	...
	public void mostrar(){ // mostrar el vector
	  for(int j=0; j<nElementos; j++) // for  
	     System.out.print(vector[j] + " "); 
	  System.out.println(" ");
	}// fin metodo mostrar
        public void mergeSort()	{ // provides espacio
	...
	} // fin metodo merge(long[] espacio, int pointer_bajo,int pointer_alto, int Limite_superior)
