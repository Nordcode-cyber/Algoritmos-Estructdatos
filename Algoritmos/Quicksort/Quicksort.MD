...
Intercambiar estos dos valores y se obtiene
`V[4 11 9 <13> 27 18 16]`
Al intentar este proceso una vez más, se encuentra que las exploraciones de los dos extremos vienen juntos sin encontrar ningún futuro valor,
Se ha realizado una partición en la lista original, que se ha quedado dividida en dos listas  pequeñas:
   `VIzq`         `VDch`
