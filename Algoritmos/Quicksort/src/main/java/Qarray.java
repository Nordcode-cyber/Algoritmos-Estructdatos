public class Qarray {
   ...
   *    Método   Quicksort
   *    Author Nordevelop
   *propiedades de la clase Qarray encapsulados 
   *con acceso denegado fuera de la clase Qarray
   */
       private long[]vector; 
       private int nElementos; 
       public Qarray(int max){ //metodo constructor
       vector = new long[max];
       nElementos = 0; 
       }
	/*
	...
	for(int j=0; j<nElementos; j++)	 // ciclo for  sin {} una sola instruccion
